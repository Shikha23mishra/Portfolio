...
🚀 **[Dev Portfolio V2 has arrived. Meet Devfolio, a modern portfolio + blog template built with GatsbyJS and TailwindCSS](https://github.com/Shikha23mishra/)**🚀
...
To view a live demo, [click here](https://github.com/Shikha23mishra/).

Looking for a blog template? Checkout [DevBlog](https://github.com/Shikha23mishra/).
...
The experience section creates a vertical timeline with all your relevant experience. The code for the timeline creation can be found within `js/scripts.js` and is an adaptation of [SHIKHA RANI GITHUB](https://github.com/Shikha23mishra/).

The default format is as follows:

```HTML
<div id="experience-timeline">
    <div data-date="September 2022 – September 2024">
        <h3>Employer Name</h3>
        <h4>Job Title</h4>
        <p>
